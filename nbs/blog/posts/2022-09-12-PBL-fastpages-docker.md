---
aliases:
- /C7.1/2022/09/12/PBL-fastpages-docker
author: Ellen Xu
categories:
- C7.1
date: '2022-09-12'
description: Serving Fastpages locally using Docker.  This allows local machine testing
  of each change of code without the delay of GitHub Actions.
image: fastpages_docker.png
layout: post
