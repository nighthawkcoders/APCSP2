...
![](integer_math_pos.png)
*Positive number*

### Basic concept, but not typically used
![](integer_math_neg.png)
*Negative number*
...
![](binary_math_conversion_example.png)
