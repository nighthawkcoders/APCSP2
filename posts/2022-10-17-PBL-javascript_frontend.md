...
comments: false
date: '2022-10-17'
description: A discussion on the frontend usage of an API. This is about creating
  a page that is well organized and updates based on the backend code created for
  the api.
keywords: fastai
layout: notebook
